...
import { fetchCryptoSignals } from '../lib/api'
...
export default function Crypto() {
  ...
  if (error) return (
    <div className="text-gray-500 p-8 text-center">
      <p>Couldn't load crypto signals. Is the server running?</p>
  ...
  return (
    <div>
      <h2 className="text-white text-xl font-semibold mb-4">Crypto Signals</h2>
      <p className="text-gray-500 text-sm mb-6">
        {signals.length} cryptocurrencies monitored (BTC, ETH, SOL). Click a card to see per-model breakdown.
      </p>
