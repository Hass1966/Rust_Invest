    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Version {manifest.version} &middot; Generated {new Date(manifest.generated_at).toLocaleString()}</p>
        </div>
        <button
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-gray-500 text-xs uppercase border-b border-[#1f2937]">
              ...
              <th className="text-right px-4 py-3">LinReg Acc</th>
              <th className="text-right px-4 py-3">LogReg Acc</th>
              <th className="text-right px-4 py-3">GBT Acc</th>
              <th className="text-right px-4 py-3">Ensemble Acc</th>
